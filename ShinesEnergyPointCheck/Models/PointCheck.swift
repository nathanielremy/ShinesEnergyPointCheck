...
struct PointCheck {
    ...
    init(id: String, dictionary: [String : Any]) {
        ...
        self.indoorUnitLocation = dictionary[Constants.indoorUnitLocation] as? String ?? ""
        ...
        self.outdoorUnitLocation = dictionary[Constants.outdoorUnitLocation] as? String ?? ""
        self.pipeLength = dictionary[Constants.pipeLength] as? Int ?? 000
        self.T1 = dictionary[Constants.T1] as? Int ?? 1
        ...
        self.IF = dictionary[Constants.IF] as? String ?? ""
        self.OF = dictionary[Constants.OF] as? String ?? ""
        self.LA = dictionary[Constants.LA] as? String ?? ""
        self.CT = dictionary[Constants.CT] as? Int ?? 000
        self.ST = dictionary[Constants.ST] as? Int ?? 000
        self.faults = dictionary[Constants.faults] as? String ??  ""
        self.remoteControlSetting = dictionary[Constants.remoteControlSetting] as? String ??  ""
        self.modeTempFolllowMe = dictionary[Constants.modeTempFollowMe] as? String ??  ""
        self.operatingPressure = dictionary[Constants.operatingPressure] as? Int ?? 000
        self.performance = dictionary[Constants.performance] as? String ?? ""
        ...
        self.comments = dictionary[Constants.comments] as? String ?? ""
